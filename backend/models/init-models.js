...
function initModels(sequelize) {
  ...
  cases.belongsTo(categories, { as: "subcategory", foreignKey: "subcategory_id"});
  categories.hasMany(cases, { as: "subcategory_cases", foreignKey: "subcategory_id"});
  ...
  proceedings_logs.belongsTo(proceedings, { as: "proceedng", foreignKey: "proceedng_id"});
  proceedings.hasMany(proceedings_logs, { as: "proceedings_logs", foreignKey: "proceedng_id"});
  roles_resources.belongsTo(resources, { as: "resource", foreignKey: "resource_id"});
  resources.hasMany(roles_resources, { as: "roles_resources", foreignKey: "resource_id"});
  roles_resources.belongsTo(roles, { as: "role", foreignKey: "roles_id"});
  roles.hasMany(roles_resources, { as: "roles_resources", foreignKey: "roles_id"});
  ...
  users.belongsTo(tenant, { as: "tenant", foreignKey: "tenant_id"});
  tenant.hasMany(users, { as: "users", foreignKey: "tenant_id"});
  cases.belongsTo(users, { as: "lawyer", foreignKey: "lawyer_id"});
  users.hasMany(cases, { as: "cases", foreignKey: "lawyer_id"});
  cases.belongsTo(users, { as: "created_by_user", foreignKey: "created_by"});
  users.hasMany(cases, { as: "created_by_cases", foreignKey: "created_by"});
  cases.belongsTo(users, { as: "updated_by_user", foreignKey: "updated_by"});
  users.hasMany(cases, { as: "updated_by_cases", foreignKey: "updated_by"});
  proceedings.belongsTo(users, { as: "created_by_user", foreignKey: "created_by"});
  users.hasMany(proceedings, { as: "proceedings", foreignKey: "created_by"});
  proceedings_logs.belongsTo(users, { as: "modified_by_user", foreignKey: "modified_by"});
  users.hasMany(proceedings_logs, { as: "proceedings_logs", foreignKey: "modified_by"});
