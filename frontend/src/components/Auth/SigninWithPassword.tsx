...
export default function SigninWithPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.error) {
      // Redirect or update the UI after successful sign-in
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4.5">
        <button
          type="submit"
          className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary p-4 mt-10 font-medium text-white transition hover:bg-opacity-90"
        >
          Sign In
        </button>
      </div>
