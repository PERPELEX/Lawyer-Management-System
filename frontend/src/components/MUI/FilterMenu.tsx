...
const FilterMenu: React.FC<FilterMenuProps> = ({
  ...
  <>
    <Tooltip title="Filter" disableHoverListener>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-filter icon"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg>
      </IconButton>
    </Tooltip>
    <Popper
